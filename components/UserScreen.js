...
const UserScreen = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      <TouchableOpacity style={styles.navItem} onPress={() => navigation.navigate('CollectionScreen')}>
        <Text style={styles.navText}>Your Collection</Text>
      </TouchableOpacity>
      <TouchableOpacity style={styles.navItem} onPress={() => navigation.navigate('WriteNote')}>
        <Text style={styles.navText}>Write Notes</Text>
      </TouchableOpacity>
      <TouchableOpacity style={styles.navItem} onPress={() => navigation.navigate('CreateMeetings')}>
        <Text style={styles.navText}>Your Meetings</Text>
      </TouchableOpacity>
      <TouchableOpacity style={styles.navItem} onPress={() => navigation.navigate('Subscription')}>
